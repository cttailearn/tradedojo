...
class FetchConfig:
    ...
    # 实测:并发 ≥ 4 时大量 RemoteDisconnected,推荐 ≤ 3
    MAX_CONCURRENT_FETCH = 3        # 最大并发请求数 (从 6 降到 3)
    REQUEST_INTERVAL = 1.5          # 单次请求间隔(秒) (从 0.3 提到 1.5)
    RETRY_TIMES = 5                 # 失败重试次数 (从 3 提到 5)
    RETRY_BACKOFF = 3.0             # 退避基数(秒) (从 2.0 提到 3.0)
    ...
    # 线程池
    MAX_WORKERS = 6                 # (从 8 降到 6,与 MAX_CONCURRENT_FETCH 协调)
